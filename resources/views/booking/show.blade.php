				...
				<div class="col-xs-12">					
						<div>
									...
									<div class="row">
										...
										<div class="col-xs-6">
											<div class="form-group {{ $errors->has('txtBookingID') ? ' has-error' : '' }}">
												...
												<div class="col-xs-5">
													<p class="control-label">{!! old('txtBookingID',isset($showbook) ? $showbook->booking_no : null) !!}</p>
												</div>
										...
										<div class="col-xs-6">
											...
											<div class="form-group {{ $errors->has('txtExportNo') ? ' has-error' : '' }}">
												...
												<div class="col-xs-5">
													<p>{!! old('txtExportNo',isset($showbook) ? $showbook->export_no : null) !!}</p>					
												</div>
											</div>
											<div class="form-group">
										...
										<div class="col-xs-12">
											<div class="form-group">
												...
												<div class="col-xs-9" style="width: 72%">
													<pre style="white-space: pre-wrap;">{!! old('txtShipper',isset($showbook) ? $showbook->shipper : null) !!}</pre>
												</div>
											</div>
										</div>
									</div><!-- //Row textarea -->
							...
							<div role="tabpanel" class="tab-pane" id="bill-off-lading">
									...
									<div class="row">
										<div class="col-xs-12">										
											<div class="form-group">
												...
												<div class="col-xs-9" style="width: 72%">
												<pre style="white-space:pre-wrap;">{!! old('txtConsignee',isset($showbook) ? $showbook->consignee : null) !!}</pre>												
												</div>
											</div>
										</div>
									</div><!-- //Row textarea -->
									...
									<!-- Row Button -->	
									{{ Form::open(array('route'=>array('booking.updatetype',$book->id),'method'=>'PUT', 'class'=> 'form-horizontal')) }}
									{!! csrf_field() !!}	
									<div class="row">
										<div class="form-group">
												<div class="col-xs-12" style="text-align: center;">
													<label class="radio-inline">
														<input type="radio" name="txtType" id="inlineRadio1" value="0" checked/> Original 
													</label>
													<label class="radio-inline">
														<input type="radio" name="txtType" id="inlineRadio2" value="1" /> Non-Negotiable
													</label>
												</div>
											</div>	
									</div>
									...
									<div class="row">
										<div class="col-xs-12 text-right">
											<div class="form-group">
												<input type='submit' href="" class="btn btn-default fa fa-external-link"  name="showBillLading" target="_blank" value="Export"> 
											</div>
										</div>
									</div>	
									{{ Form::close() }}			
									...
									<div class="row">									
										<div class="col-xs-12">								
											<div class="form-group">
												...
												<div class="col-xs-9" style="width: 72%">
													<pre>{!!old('txtExport',isset($showbook) ? $showbook->exporter : null)!!}</pre>
												</div>
											</div>
										</div>
									</div><!-- //Row textarea -->
									...
									<div class="row">														
										...
										<div class="col-xs-6">
											<div class="form-group">
												...
												<div class="col-xs-7">
													<p  class="control-label">&nbsp;{!! old('txtMode',isset($showbook) ? $showbook->mode : null) !!}
													</p>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-xs-7">
													<p class="control-label">&nbsp;{!! old('txtContainerNo',isset($showbook) ? $showbook->container_no : null) !!}</p>			
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-5 control-label" for="business_phone_company">MASTER B/L</label>
												<div class="col-xs-7">
													<p  class="control-label">&nbsp;{!! old('txtMasterBL',isset($showbook) ? $showbook->master_BL : null) !!}</p>													
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-5 control-label" for="business_phone_company">HOUSE B/L</label>
												<div class="col-xs-7">
													<p class="control-label">&nbsp;{!! old('txtHouseBL',isset($showbook) ? $showbook->House_BL : null) !!}</p>				
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-5 control-label" for="business_phone_company">IT NO.</label>
												<div class="col-xs-7">
													<p class="control-label">&nbsp;{!! old('txtITNo',isset($showbook) ? $showbook->IT_no : null) !!}</p>						
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-5 control-label" for="business_phone_company">LAST FREE DATE</label>
												<div class="col-xs-7">
													<p  class="control-label">&nbsp;{!! old('txtLastFreeDate',isset($showbook) ? date_format(date_create($showbook->last_free_date),"m/d/Y") : null) !!}</p>	
												</div>
											</div>
										</div><!-- //End col -->
										<!-- Start col -->
										<div class="col-xs-6">
											<div class="form-group">
												...
												<div class="col-xs-7">
													<p class="control-label">&nbsp;{!! old('txtPUNo',isset($showbook) ? $showbook->PU_no : null) !!}</p>	
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-5 control-label" for="business_phone_company">SHIPPING LINE</label>
												<div class="col-xs-7">
													<p class="control-label">&nbsp;{!! old('txtShippingLine',isset($showbook) ? $showbook->shipping_line : null) !!}</p>												
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-5 control-label" for="business_phone_company">AMS B/L</label>
												<div class="col-xs-7">
													<p class="control-label">&nbsp;{!! old('txtAMS',isset($showbook) ? $showbook->AMS_BL : null) !!}</p>				
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-5 control-label" for="business_phone_company">FINAL E.T.A</label>
												<div class="col-xs-7">
													<p class="control-label">&nbsp;{!! old('txtFinalETA',isset($showbook) ? $showbook->Final_ETA : null) !!}</p>				
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-5 control-label" for="business_phone_company">DATE IT ISSUED</label>
												<div class="col-xs-7">
													<p class="control-label">&nbsp;{!! old('txtDateIssued',isset($showbook) ? date_format(date_create($showbook->date_it_issued),"m/d/Y") : null) !!}</p>					
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-5 control-label" for="business_phone_company">G.O DATE</label>
												<div class="col-xs-7">
												<p class="control-label">&nbsp;{!! old('txtGODate',isset($showbook) ? date_format(date_create($showbook->GO_date),"m/d/Y") : null) !!}</p>
												</div>
											</div>
										</div><!-- //End col -->
									</div><!-- //End Row -->
									...
									<div class="row">
										...
										<div class="col-xs-6">
											<div class="form-group">
												...
												<div class="col-xs-5">
													<p class="control-label">{!! old('txtFreightCollect',isset($showbook) ? $showbook->freight_collect : null) !!}</p>														
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-7 control-label" for="business_phone_company">HANDLING FEE</label>
												<div class="col-xs-5">
													<p class="control-label">{!! old('txtHandlingFee',isset($showbook) ? $showbook->handling_fee : null) !!}</p>												
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-7 control-label" for="business_phone_company">AMS FEE</label>
												<div class="col-xs-5">
													<p class="control-label">{!! old('txtAMSFee',isset($showbook) ? $showbook->ams_fee : null) !!}</p>														
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-7 control-label" for="business_phone_company">D.D.C</label>
												<div class="col-xs-5">
													<p class="control-label">{!! old('txtDDC',isset($showbook) ? $showbook->ddc : null) !!}</p>													
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-7 control-label" for="business_phone_company">DEMURRAGE</label>
												<div class="col-xs-5">
													<p class="control-label">{!! old('txtDemurrage',isset($showbook) ? $showbook->demurrage : null) !!}</p>														
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-7 control-label" for="business_phone_company">INLAND FREIGHT</label>
												<div class="col-xs-5">
													<p class="control-label">{!! old('txtInlandFreight',isset($showbook) ? $showbook->inland_freight : null) !!}</p>													
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-7 control-label" for="business_phone_company">CUSTOM CLEARANCE</label>
												<div class="col-xs-5">
													<p class="control-label">{!! old('txtCustomClearance',isset($showbook) ? $showbook->custom_clearance : null) !!}</p>													
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-7 control-label" for="business_phone_company">CUSTOM DUTY</label>
												<div class="col-xs-5">
													<p class="control-label">{!! old('txtCustomDuty',isset($showbook) ? $showbook->custom_duty : null) !!}</p>	
											...
											<div class="form-group">
												...
												<div class="col-xs-5">
													<p class="control-label">{!! old('txtCustomBond',isset($showbook) ? $showbook->custom_bond : null) !!}</p>														
												</div>
											</div>
										</div><!-- //End col -->
										<!-- Start col -->
										<div class="col-xs-6">
											...
											<div class="form-group">
												...
												<div class="col-xs-5">
													<p class="control-label">{!! old('txtExamFee',isset($showbook) ? $showbook->examination_fee : null) !!}</p>														
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-7 control-label" for="business_phone_company">CFS IN & OUT CHARGES</label>		
												<p class="col-xs-5 control-label">{!! old('txtCFSCharges',isset($showbook) ? $showbook->cfs_charges : null) !!}</p>
											</div>
											<div class="form-group">
												<label class="col-xs-7 control-label" for="business_phone_company">T.H.C FEE</label>
												<p class="col-xs-5 control-label">{!! old('txtTHCFee',isset($showbook) ? $showbook->thc_fee : null) !!}</p>												
											</div>
											<div class="form-group">
												<label class="col-xs-7 control-label" for="business_phone_company">ORIGIN CUSTOME CHARGES</label>
												<div class="col-xs-5">
													<p class="control-label">{!! old('txtOriginCharges',isset($showbook) ? $showbook->origin_charges : null) !!}</p>													
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-7 control-label" for="business_phone_company">CHASSIS CHARGES</label>
												<div class="col-xs-5">
													<p class="control-label">{!! old('txtChassisCharges',isset($showbook) ? $showbook->chassis_charges : null) !!}</p>													
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-7 control-label" for="business_phone_company">PIER PASS CHARGES</label>
												<div class="col-xs-5">
													<p class="control-label">{!! old('txtPierPassCharges',isset($showbook) ? $showbook->pier_pass_charges : null) !!}</p>
											...
											<div class="form-group">
												...
												<div class="col-xs-5">
													<p class="control-label">{!! old('txtITEntryCharges',isset($showbook) ? $showbook->IT_entry_charges : null) !!}</p>													
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-7 control-label" for="business_phone_company">AMOUNT DUE ($USD)</label>
												<div class="col-xs-5">
													<p  class="control-label">{!! old('txtAmountDue',isset($showbook) ? $showbook->amount_due : null) !!}</p>												
												</div>
											</div>
										</div><!-- //End col -->
									</div><!-- //End Row -->
									...
									<div class="row">
										<div class="col-xs-12">
											<div class="form-group">
												...
												<p class="col-xs-9 control-label">{!! old('txtPrepareBy',isset($showbook) ? $showbook->prepare_by : null) !!}</p>																			
											</div>
										</div>
									</div><!-- //Row textarea -->
									<!-- Row Button -->
