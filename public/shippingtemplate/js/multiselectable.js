...
(function ($) {
	$.fn.multiselectable = function (options) {
		var that = $(this);
		options = $.extend({
			template: '<div class="multiselectable col-xs-12">' +
				'<div class="m-selectable-from col-xs-5"><label for="m-selectable" class="control-label"></label>' +
				'<select multiple="multiple" id="m-selectable" class="form-control input-sm"></select>' +
				'</div>' +
				'<div class="m-selectable-controls col-xs-2">' +
					'<button class="multis-right btn btn-info btn-sm"></button>' +
					'<button class="multis-left btn btn-info btn-sm"></button>' +
				'</div>' +
				'<div class="m-selectable-to col-xs-5"><label for="m-selected" class="control-label">gdggsd</label>' +
				'<select multiple="multiple" id="m-selected" class="form-control input-sm"></select>' +
				'</div>' +
			'</div>',
