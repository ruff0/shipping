...
function Keypad() {
	...
	this.qwertyLayout = ['1234567890' + this.SPACE + this.CLOSE,
		'qwertyuiop' + this.SPACE + this.BACK,
		'asdfghjkl' + this.START + this.SPACE + this.SPACE + this.CLEAR,
		'zxcvbnm' + this.END + this.SHIFT];
